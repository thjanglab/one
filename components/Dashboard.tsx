...
const Dashboard: React.FC = () => {
  ...
  const executeCancellation = (id: string) => {
      ...
      if (assetToCancel) {
          ...
          const cancelTx = {
              ...
              asset: `${assetToCancel.title} (Refund/Cancel)`,
  ...
  const incomeTrend = [
      { name: 'Jan', value: 32000 }, { name: 'Feb', value: 35000 }, { name: 'Mar', value: 34000 },
      { name: 'Apr', value: 38000 }, { name: 'May', value: 42000 }, { name: 'Jun', value: 45200 },
  ];
  const incomeSources = [
      { name: 'Data Sales', value: 65, color: '#3b82f6' },
      { name: 'Asset Rental', value: 25, color: '#10b981' },
      { name: 'Royalties', value: 10, color: '#8b5cf6' },
  ];

  const expenseTrend = [
      { name: 'Jan', value: 11000 }, { name: 'Feb', value: 12500 }, { name: 'Mar', value: 11800 },
      { name: 'Apr', value: 14000 }, { name: 'May', value: 13200 }, { name: 'Jun', value: 13500 },
  ];
  const expenseCategories = [
      { name: 'Asset Subscriptions', value: 55, color: '#ef4444' },
      { name: 'Compute Resources', value: 30, color: '#f59e0b' },
      { name: 'Network Fees', value: 15, color: '#64748b' },
  ];
                  ...
                  <div className="p-8">
                      <div className="space-y-6">
                          <div className={`flex items-center gap-4 ${launchStep >= 0 ? 'opacity-100' : 'opacity-30'}`}>
                              ...
                              <span className={launchStep === 0 ? 'text-blue-400 font-bold animate-pulse' : 'text-slate-300'}>Initializing Container...</span>
                          </div>
                          <div className={`flex items-center gap-4 ${launchStep >= 1 ? 'opacity-100' : 'opacity-30'}`}>
                              ...
                              <span className={launchStep === 1 ? 'text-blue-400 font-bold animate-pulse' : 'text-slate-300'}>Establishing EDC Connection...</span>
                          </div>
                          <div className={`flex items-center gap-4 ${launchStep >= 2 ? 'opacity-100' : 'opacity-30'}`}>
                              ...
                              <span className={launchStep === 2 ? 'text-blue-400 font-bold animate-pulse' : 'text-slate-300'}>Verifying Access Token...</span>
                          </div>
                      </div>
                      ...
                      {launchStep === 3 && (
                          <div className="mt-8 text-center animate-scaleUp">
                              ...
                              <button 
                                  onClick={() => { alert("Opening Application..."); setShowLaunchModal(false); }}
                  ...
                  <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="space-y-4">
                          <h3 className="font-bold text-slate-800 flex items-center gap-2">
                              <Activity className="w-4 h-4 text-blue-500" /> 6-Month Trend
                          </h3>
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                              <div className="flex justify-between items-center mb-1">
                                  <span className="text-sm font-medium text-slate-500">Total {activeReport === 'INCOME' ? 'Income' : 'Expenses'}</span>
              ...
              <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden animate-scaleUp flex flex-col max-h-[85vh]">
                  <div className="p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50">
                      <div>
                          <h2 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                              <Database className="w-5 h-5 text-blue-600" /> Transaction History
                          </h2>
                          <p className="text-xs text-slate-500">Full ledger of smart contract executions</p>
                      </div>
                  ...
                  <div className="p-4 border-b border-slate-100 flex gap-4">
                      <div className="relative flex-1">
                          ...
                          <input 
                              type="text" 
                              placeholder="Search by Asset, ID, or Date..." 
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-fadeIn">
              <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 relative">
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl mb-6 border border-slate-100">
                      ...
                      <p className="text-xs text-slate-500 mt-1">Status: Active • Renewing in 30 days</p>
                  </div>
                  ...
                  {!confirmingCancel ? (
                      ...
                      <div className="space-y-3 animate-fadeIn">
                          <p className="text-sm text-center font-bold text-slate-700">Are you sure you want to cancel?</p>
                ...
                <div className="p-6">
                        ...
                        <div className="space-y-6 animate-fadeIn">
                            ...
                            {paymentMethod === 'CRYPTO' && (
                                <div className="text-center py-4 bg-slate-50 rounded-xl border border-slate-200">
                                    <img src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=0x123`} alt="QR" className="mx-auto mb-3 rounded-lg mix-blend-multiply" />
                    ...
                    {topUpStep === 'SUCCESS' && (
                        <div className="py-12 flex flex-col items-center justify-center text-center animate-scaleUp">
                            ...
                            <p className="text-slate-500 mb-6">Your wallet has been recharged with <strong>${topUpAmount.toLocaleString()}</strong>.</p>
                            <button 
      ...
      <div className="bg-slate-900 text-white rounded-xl p-6 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-4">
             ...
             <div>
                 ...
                 <p className="text-slate-400 text-sm">Connection ID: edc-provider-kr-001 • v0.5.2</p>
             </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10">
                ...
                <p className="text-xs text-slate-400 font-mono mb-4">Wallet ID: 0x71C...9A23</p>
        ...
        >
            ...
            <p className="text-[10px] text-slate-400 mt-2 text-right">Click for report</p>
        </div>
