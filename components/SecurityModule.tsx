        ...
        <div className="space-y-12 animate-fadeIn">
            ...
            <div className="bg-slate-900 rounded-3xl p-8 relative overflow-hidden shadow-2xl border border-slate-800 min-h-[500px]">
                ...
                <div className="absolute top-0 left-0 w-full h-[40%] border-b border-slate-700/50 bg-slate-800/30 z-10 flex flex-col items-center justify-center">
                    ...
                    {/* Label kept outside the stretched viewBox so the text is not distorted */}
                    <svg className="absolute inset-0 w-full h-full pointer-events-none">
                        <text x="50%" y="40%" fill="#64748b" fontSize="10" textAnchor="middle">Metadata Only</text>
                    </svg>
                </div>

                {/* 2. Data Plane (Lower Layer) */}
                <div className="absolute bottom-0 left-0 w-full h-[60%] flex items-center justify-between px-16 relative">
                    ...
                    <div className="flex-1 mx-8 h-24 bg-slate-800/50 rounded-xl border border-slate-700 relative overflow-hidden flex items-center">
                        ...
                        <div className="absolute top-2 left-1/2 -translate-x-1/2 bg-emerald-500/20 text-emerald-400 px-3 py-1 rounded-full text-xs font-bold border border-emerald-500/50 flex items-center gap-1">
                            <Lock className="w-3 h-3" /> TLS 1.3 / mTLS Tunnel
                        </div>
